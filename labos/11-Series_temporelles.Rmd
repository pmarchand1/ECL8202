...
(e) Quel type de modèle est choisi par `ARIMA()` si vous ne considérez que la sous-série débutant en l'an 2000? Expliquez ce choix à partir du graphique en (a) et des corrélations temporelles pour cette sous-série.
